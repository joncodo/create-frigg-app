...
class Api extends OAuth2Requester {
    constructor(params) {
        ...
        this.tenant_id = process.env.SHAREPOINT_TENANT_ID;
        this.client_id = process.env.SHAREPOINT_CLIENT_ID;
        this.client_secret = process.env.SHAREPOINT_CLIENT_SECRET;
        this.redirect_uri = `${process.env.REDIRECT_URI}/sharepoint`;
        this.scopes = process.env.SHAREPOINT_SCOPES;
        ...
        const tokenUri = `https://login.microsoftonline.com/${this.tenant_id}/oauth2/v2.0/token?client_id=${this.client_id}&redirect_uri=${this.redirect_uri}&scope=${this.scopes}&grant_type=client_credentials`;

        this.authorizationUri = encodeURI(tokenUri);
    ...
    async createTimelineEvent(
        objId,
        data,
        eventTemplateId = process.env.SHAREPOINT_TIMELINE_EVENT_TEMPLATE_ID
    ) {
        /*
        Example data:
        {
