...
describe('SharePoint API ', () => {
    ...
    beforeAll(async () => {
        ...
        let res = await chai
            ...
            .query({
                ...
                connectingEntityType: 'sharepoint',
            });
        ...
        // api = new SharePointApi({
        //   key : process.env.SHAREPOINT_CLIENT_ID,
        //   secret : process.env.SHAREPOINT_CLIENT_SECRET,
        //   redirectUri : process.env.SHAREPOINT_OAUTH_REDIRECT_URI,
        //   authorizationUri : `https://app.sharepoint.com/oauth/authorize?client_id=${process.env.SHAREPOINT_CLIENT_ID}&` +
        //   `redirect_uri=${process.env.REDIRECT_URI}&scope=contacts%20oauth&state=app:SHAREPOINT`,
    ...
    //     beforeAll(async () => {
    //         let body = {
    //             email: 'jose.miguel@sharepoint.com',
    //             firstname: 'Miguel',
    //             lastname: 'Delgado',
    //         };
    ...
    //             {
    //                 properties: {
    //                     email: 'jose.miguel3@sharepoint.com',
    //                     firstname: 'Miguel',
    //                     lastname: 'Delgado',
    //                 },
    //             },
    //             {
    //                 properties: {
    //                     email: 'jose.miguel2@sharepoint.com',
    //                     firstname: 'Miguel',
    //                     lastname: 'Delgado',
    //                 },
    //             },
